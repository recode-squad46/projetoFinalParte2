...
<title>LeTurminha - Lista de Partidas</title>
    	...
    	<section>
     	   <div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="cold-md-7">
						<hr>
						<h3 class="titulo-aba d-flex justify-content-center">Partidas Cadastradas</h3>
						<hr>
					</div>
					<table class="table tabela-padrao">
						...
						<tbody>
							<c:forEach items="${partidasMemoria}" var="partidaMemoria">
								<tr>
									<td>${partidaMemoria.id}</td>
