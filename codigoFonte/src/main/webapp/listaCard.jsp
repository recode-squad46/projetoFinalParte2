...
<title>LeTurminha - Lista de Cards</title>
            ...
            <div class="d-flex align-items-center">
                <nav>
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active cor-link aba-selecionada" href="CardMakeAndSearch">Cards</a>
                        </li>
                        <li class="nav-item">
    	...
    	<section>
    		<div class="container d-flex align-items-center justify-content-center py-3">
    		    <nav>
                    <ul class="nav px-5">
                        <li class="nav-item">
                            <a class="nav-link active cor-link2" href="./cadastroCard.jsp">Novo Cadastro</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active cor-link2" href="CardMakeAndSearch">Lista de Cards</a>
                        </li>
                    </ul>
                </nav>
               		 <form action="CardMakeAndSearch" method="GET" class="d-flex">
    	...
    	<section>
     	   <div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="cold-md-7">
						<hr>
						<h3 class="titulo-aba d-flex justify-content-center">Cards Cadastrados</h3>
						<hr>
					</div>
						...
						<tbody>
							<c:forEach items="${cards}" var="card">
								<tr>
									<td>${card.id}</td>
									<td>${card.nome}</td>
									<td><img class="imagem-tamanho-max" src="${card.imgCard}"></td>
									<td class="largura-botoes-tabela">
										<a href="CardUpdate?cardId=${card.id}"> <button type="submit" class="btn btn-config"> <i class="bi bi-pencil-square"></i> Alterar</button></a>
										<a href="CardRemove?cardId=${card.id}"> <button type="submit" class="btn btn-config-delete"> <i class="bi bi-trash3-fill"></i> Deletar</button></a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
