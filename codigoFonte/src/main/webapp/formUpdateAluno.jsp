...
<title>Wallz Tour - Alterar Aluno</title>
    	...
    	<section>
     	   <div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="col-md-7">
						<hr>
						<h3 class="titulo-aba d-flex justify-content-center">Alterar dados do Aluno</h3>
						<hr>
						<form action="AlunoUpdate" method="POST">
							<input value="${aluno.id}" name="id" style="visibility:hidden">
							<input value="${aluno.idProfessor}" name="idProfessor" type="number" style="visibility:hidden">
							<div class="py-2">
									<label>Nome completo</label>
									<input value="${aluno.nome}" name="nome" maxlength="300" type="text" class="form-control" id="floatingInput1"> 
							</div>									
