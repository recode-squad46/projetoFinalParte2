...
<title>LeTurminha- Cadastro de Professores</title>
    	...
    	<section>
     	   <div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="col-md-7">
						<hr>
						<h3 class="titulo-aba d-flex justify-content-center">Cadastro de Novo Professor</h3>
						<hr>
						
						<form action="ProfessorMakeAndSearch" method="POST">
							<div class="py-2">
