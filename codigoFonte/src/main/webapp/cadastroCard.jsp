...
<title>LeTurminha- Cadastro de Cards</title>
    	...
    	<section>
     	   <div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="col-md-7">
						<hr>
						<h3 class="titulo-aba d-flex justify-content-center">Cadastro de Novo Card</h3>
						<hr>
						
						<form action="CardMakeAndSearch" method="POST">
							<div class="py-2">
									<label>Nome do card</label>
									<input name="nome" maxlength="50" type="text" class="form-control" id="floatingInput1"> 
							</div>
							<div class="py-2">
									<label>Url da imagem do card</label>
									<input name="imgCard" maxlength="1000" type="text" class="form-control" id="floatingInput2"> 
							</div>
