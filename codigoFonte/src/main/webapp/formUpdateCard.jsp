...
<title>Wallz Tour - Alterar Card</title>
    	...
    	<section>
     	   <div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="col-md-7">
						<hr>
						<h3 class="titulo-aba d-flex justify-content-center">Alterar dados do Card</h3>
						<hr>
						<form action="CardUpdate" method="POST">
							<input value="${card.id}" name="id" style="visibility:hidden">
							<div class="py-2">
									<label>Nome do card</label>
									<input value="${card.nome}" name="nome" maxlength="50" type="text" class="form-control" id="floatingInput1"> 
							</div>
							<div class="py-2">
									<label>Url da imagem do card</label>
									<input value="${card.imgCard}" name="imgCard" maxlength="1000" type="text" class="form-control" id="floatingInput2"> 
							</div>									
