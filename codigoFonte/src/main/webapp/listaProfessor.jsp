...
<title>LeTurminha - Lista de Professores</title>
    	...
    	<section>
     	   <div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="cold-md-7">
						<hr>
						<h3 class="titulo-aba d-flex justify-content-center">Professores Cadastrados</h3>
						<hr>
					</div>
						...
						<tbody>
							<c:forEach items="${professores}" var="professor">
								<tr>
									...
									<!-- A senha do usuário não pode aparecer <td>${professor.senha}</td>-->
									<td class="largura-botoes-tabela">
										<a href="ProfessorUpdate?professorId=${professor.id}"> <button type="submit" class="btn btn-config"> <i class="bi bi-pencil-square"></i> Alterar</button></a>
										<a href="ProfessorRemove?professorId=${professor.id}"> <button type="submit" class="btn btn-config-delete"> <i class="bi bi-trash3-fill"></i> Deletar</button></a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
